...
import 'package:m_y_task/splash_screen/splash_screen_widget.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<MYTaskFirebaseUser> userStream;
  MYTaskFirebaseUser initialUser;

  @override
  void initState() {
    super.initState();
    userStream = mYTaskFirebaseUserStream()
